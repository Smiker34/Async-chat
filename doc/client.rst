...
``python class_client.py {имя сервера} {порт} -n или --name {имя пользователя} -p или -password {пароль}``
...
* ``python class_client.py``

*Запуск приложения с параметрами по умолчанию.*

* ``python class_client.py ip_address some_port``
...
* ``python class_client.py ip_address some_port -n test1 -p 123``
...
.. autoclass:: client gui.database.ClientDatabase
	:members:
	
transport.py
~~~~~~~~~~~~~~

.. autoclass:: client gui.transport.ClientTransport
	:members:

main_window.py
~~~~~~~~~~~~~~

.. autoclass:: client gui.main_window.ClientMainWindow
	:members:

start_dialog.py
~~~~~~~~~~~~~~~

.. autoclass:: client gui.start_dialog.UserNameDialog
	:members:
...
.. autoclass:: client gui.add_contact.AddContactDialog
	:members:
...
.. autoclass:: client gui.del_contact.DelContactDialog
	:members: